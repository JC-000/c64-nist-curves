...
; =============================================================================
; constants.s - System equates, hardware addresses
; For P-256 and P-384 NIST curve optimization
;
; Zero-page allocation lives in zp_config.s (consumer-tunable). Hardware
...
; --- Exports ---
.export chrout, getin, vic_ctrl1, vic_border, vic_bg
.export cia1_ta_lo, cia1_ta_hi, cia1_cra
.export screen_ram, color_ram, cassette_buf
.exportzp jiffy_clock
.export reu_status, reu_command, reu_c64_lo, reu_c64_hi
.export reu_reu_lo, reu_reu_hi, reu_reu_bank
.export reu_len_lo, reu_len_hi, reu_addr_ctrl
.export FP256_SIZE, FP384_SIZE
