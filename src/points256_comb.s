...
; =============================================================================
; points256_comb.s - P-256 Lim-Lee fixed-base comb (Wave 7a h=8).
;
; Hosts ec_precompute_256 and ec_scalar_mul (fixed-base k*G) plus the
; sm256_reu_* helpers they use to stash/fetch 64-byte affine table entries
; in REU bank 2. Excluded from lib-p256-verify (variable-base verify uses
; ec_scalar_mul_var from points256_core.s instead).
;
